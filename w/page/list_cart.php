...
<div class="container mt-4">
    <div class="row">
        <div class="col-lg-12 bg-light">
         <a href="?menu=product" class="btn" style="margin:3px; background-color:#DAA520; color:white;"><i class="fas fa-shopping-basket"></i>&nbsp;Belanja lagi</a>
         <a href="#" data-toggle="modal" data-target="#payModal" class="btn"><button type="button" class="btn" style="background-color:#DAA520; color:white;" onclick="enableButton2()"><i class="fas fa-money-bill">&nbsp;Pembayaran</i></button></a>
	...
	<span class="alert alert-danger">
     <b>Note : Minimum Pembelian Rp 100.000, 
     Pembelian botol gallon untuk awal Rp 55.000 Air + Gallon, dan
     Klik Selesai setelah melakukan pembayaran
     </b>
    </span>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Pilih Metode Pembayaran : </p>
         <div class="row">
          <div class="col-6">
            <a href="#" id="pay-button" class="btn" style="margin:3px; width: 100%; background-color:#DAA520; color:white;" data-dismiss="modal"><i class="fas fa-money-bill" onclick="enableButton2()"></i>&nbsp;&nbsp;MidTrans</a>
          </div>
          <div class="col-6">
            <a href="#" data-toggle="modal" data-target="#transferModal" class="btn" style="margin:3px; width: 100%; background-color:#DAA520; color:white;" data-dismiss="modal"><i class="fas fa-credit-card"></i>&nbsp;&nbsp;Transfer Bank</a>
          </div>
        </div>
      </div>
