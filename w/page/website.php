                    ...
                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                      <div class="media">
                         <a href="javascript: void(0);">
                             <img src="../img/<?php echo $a['logo'] ?>" class="rounded mr-75" height="64" width="64">
                          </a>
                       ...
                       <div class="row">                                                       
                          ...
                          <div class="form-group">
                            <div class="controls">
                              <label for="account-name">Name</label>
                     			<input type="text" class="form-control" value="<?php echo $a['nm_toko'] ?>">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-12">
                          <div class="form-group">
                            <div class="controls">
                              <label>Alamat</label>
                                <input type="text" class="form-control" value="<?php echo $a['almt_toko'] ?>">
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                             <div class="controls">
                                 <label>Kecamatan</label>
                                    <input type="text" class="form-control" value="<?php echo $a['kecamatan_toko'] ?>">
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                          <div class="form-group">
                             <div class="controls">
                                 <label>Kota</label>
                                    <input type="text" class="form-control" value="<?php echo $a['kota_toko'] ?>">
                              </div>
                            </div>
                        </div>
                          ...
                          <div class="form-group">
                             <div class="controls">
                                 <label>Tema Header</label>
                                    <input type="text" id="headerfooter" class="form-control" value="<?php echo $a['headerfooter'] ?>">
                              </div>
                            </div>
                        </div>
                          ...
                          <div class="form-group">
                             <div class="controls">
                                 <label>Background</label>
                                    <input type="text" id="latar" class="form-control" value="<?php echo $a['background'] ?>">
                              </div>
                            </div>
                        </div>
                          ...
                          <div class="form-group">
                             <div class="controls">
                                 <label>Tema Tombol</label>
                                    <input type="text" id="tombol" class="form-control" value="<?php echo $a['tombol'] ?>">
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="controls">
                            <label for="account-old-password">Password Lama</label>
                               <input type="text" class="form-control" value="<?php echo $a['pass'] ?>">
                          </div>
                        </div>
                      </div>
