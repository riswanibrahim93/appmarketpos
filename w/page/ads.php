...
<div class="card">
 <div class="card-body">
  <div class="divider">
    <div class="divider-text"><h3 class="mb-3 display-4 text-uppercase">Data Informasi</h3></div>
   </div>
   <div class="row">
                ...
                <div class="col-12 mt-1 mb-2">
                  <div class="font-small-2 mb-1">Keterangan</div>
                   <fieldset class="form-label-group mb-0">
                     <textarea data-length=100 class="form-control char-textarea" rows="3" name="keterangan" placeholder="Isi  Disini"></textarea>
                   </fieldset>
                   <small class="counter-value float-right"><span class="char-count">maks.</span> / 100 karakter</small>
                 </div>        
                
                <div class="col-12 mt-1 mb-2">
                <input type="submit" name="upload_ads" value="Upload" class="btn btn-primary rounded-0" />
  ...
  <div class="col-lg-7 col-12">
     <div class="badge badge-primary float-right">
      <?php $sql_user = mysqli_query($koneksi,"SELECT * FROM tabel_slide"); $jumlah_user = mysqli_num_rows($sql_user); ?>
...
<!---------------------------------------- Modal ads------------------------------------>
<div class="modal fade" id="modal_ads" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
