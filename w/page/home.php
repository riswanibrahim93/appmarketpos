...
<?php $satQuery = "SELECT COUNT(id_info) as info FROM tabel_info";
      $executeSat = mysqli_query($koneksi, $satQuery);
      while ($info=mysqli_fetch_array($executeSat)) {
?>                        
          <div class="col-xl-3 col-md-4 col-sm-6 col-6">
            ...
            <div class="card text-center">
               <div class="card-content">
                  <div class="card-body">
                    ...
                    <h2 class="text-bold-700"><?=$info['info']?></h2>
                  <p class="mb-0 line-ellipsis">Info</p>
                </div>
             </div>
            </div>
            </a>
