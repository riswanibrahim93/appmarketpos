                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-0">
                                            <div class="card-title">
                                                <h4 class="text-uppercase">Halaman masuk ke aplikasi <?php echo $toko;?></h4>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <form action="aksi_login.php" method="post">
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="text-right font-small-2"><a href="lupa-password.php" class="card-link">Lupa Password?</a></div>
                                                    </div>
                                                    <a href="daftar.php" class="btn btn-outline-primary float-left btn-inline">Daftar</a>
